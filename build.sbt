...
// Delta artifacts are consumed by the CLI (kernel) and the Spark connector tests only; keep the
// pin in one place so the two never drift apart.
lazy val deltaVersion = "3.3.3"
